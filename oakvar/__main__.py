...
# module
p_module = sp_entry.add_parser("module", parents=[parser_fn_module], description="Manages OakVar modules", add_help=False, help="Manages OakVar modules")

# config
p_config = sp_entry.add_parser("config", parents=[parser_fn_config], description="View and change configuration settings", add_help=False, help="View and change configurations")

# new
p_new = sp_entry.add_parser("new", parents=[parser_fn_new], description="Create new modules", add_help=False, help="Create OakVar example input files and module templates")

# store
p_store = sp_entry.add_parser("store", parents=[parser_fn_store], description="Publish modules to the store", add_help=False, help="Publish modules to the store")

# util
p_util = sp_entry.add_parser("util", parents=[parser_fn_util], description="Utilities", add_help=False, help="OakVar utilities")
