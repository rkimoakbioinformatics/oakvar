...
function createGlobalStates$i() {
  ...
  const withCredentials = origin.startsWith("http://localhost:3000") || origin.startsWith("http://0.0.0.0:3000");
  return {
    serverUrl,
    withCredentials,
    wsUrl
...
const gvServer = createRoot(createGlobalStates$i);
...
const gvEmail = createRoot(createGlobalStates$h);

var _tmpl$$1r = /* @__PURE__ */ template(`<div><span></span><br>`);
function createGlobalStates$g() {
  ...
  function getErrorText() {
    ...
    return createComponent(For, {
      each: lines,
      children: (line) => (() => {
        var _el$ = _tmpl$$1r(), _el$2 = _el$.firstChild;
        insert(_el$2, line);
        return _el$;
      })()
    });
...
const gvErrorDialogState = createRoot(createGlobalStates$g);
...
const gvSystemSetupNeeded = createRoot(createGlobalStates$f);
...
const gvMultiuser = createRoot(createGlobalStates$e);
...
const gvFirebase = createRoot(createGlobalStates$d);
...
const gvTabName = createRoot(createGlobalStates$c);
...
function createGlobalStates$b() {
  ...
  function afterLogin(user) {
    const email2 = getEmailFromUserResponse(user);
    if (!email2) {
      handleError({
        response: {
  ...
  function resetPassword(setPasswordResetEmailOk) {
    sendPasswordResetEmail(auth(), email()).then(function(_) {
      setPasswordResetEmailOk(true);
    }).catch(function(err) {
      handleError(err);
    });
  }
...
const gvLogin = createRoot(createGlobalStates$b);
...
const gvAppLoading = createRoot(createGlobalStates$a);

var _tmpl$$1q = /* @__PURE__ */ template(`<a href=# class=tabhead>`);
function TabHead(props) {
  ...
  return (() => {
    ...
    createRenderEffect((_p$) => {
      var _v$ = "tabhead_" + props.tabName, _v$2 = !!(tabName() == props.tabName), _v$3 = !!props.disable, _v$4 = !!props.disable, _v$5 = !props.disable, _v$6 = !!props.highlight;
      _v$ !== _p$.e && setAttribute(_el$, "id", _p$.e = _v$);
      _v$2 !== _p$.t && _el$.classList.toggle("selected", _p$.t = _v$2);
      _v$3 !== _p$.a && _el$.classList.toggle("pointer-events-none", _p$.a = _v$3);
      _v$4 !== _p$.o && _el$.classList.toggle("text-gray-400", _p$.o = _v$4);
      _v$5 !== _p$.i && _el$.classList.toggle("text-gray-600", _p$.i = _v$5);
      _v$6 !== _p$.n && _el$.classList.toggle("bg-indigo-200", _p$.n = _v$6);
      return _p$;
    }, {
      e: void 0,
      t: void 0,
...
var _tmpl$$1p = /* @__PURE__ */ template(`<svg stroke-width=0>`);
...
function RiBuildingsStore2Line(props) {
  ...
  function RiDeviceRotateLockFill(props) {
      return IconTemplate({
        a: {"viewBox":"0 0 24 24"},
...
var _tmpl$$1o = /* @__PURE__ */ template(`<svg class=tabheadicon xmlns=http://www.w3.org/2000/svg fill=none viewBox="0 0 24 24"stroke-width=2 stroke=currentColor><path stroke-linecap=round stroke-linejoin=round d="M10.5 6h9.75M10.5 6a1.5 1.5 0 11-3 0m3 0a1.5 1.5 0 10-3 0M3.75 6H7.5m3 12h9.75m-9.75 0a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m-3.75 0H7.5m9-6h3.75m-3.75 0a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m-9.75 0h9.75">`);
...
function createGlobalStates$9() {
  const [enterprise, setEnterprise] = createSignal(null);
  const {
    serverUrl,
    withCredentials
  } = gvServer;
  ...
  function getEnterprise() {
    axios.get(serverUrl + "/store/storeurl").then(function(res) {
      var storeUrl = res.data.store_url;
      axios.get(serverUrl + "/system/ez").then(function(res2) {
        var email = res2.data.email;
        var ez = res2.data.ez;
        var idToken = res2.data.idToken;
        if (ez == "") {
          setEnterprise(false);
        } else {
          document.cookie = document.cookie + "; ez=" + ez;
          axios({
            method: "post",
            url: storeUrl + "/ez",
            data: {
...
function TabHeadLogging() {
  ...
  const [passwordResetEmailOk, setPasswordResetEmailOk] = createSignal(false);
  ...
  const svgChangePassword = createComponent(RiDeviceRotateLockFill, {
    "class": "tabheadicon",
    color: "rgb(156 163 175)"
  });
  ...
  createEffect(function() {
    if (passwordResetEmailOk() == true) {
      setOkDialogTitle("Success");
      setOkDialogText("Please check your inbox for a password reset email.");
  ...
  function onClickChangePassword(_) {
    ...
    insert(_el$, createComponent(Show, {
      ...
      get children() {
        return createComponent(Show, {
          ...
          get children() {
            var _el$2 = _tmpl$2$i(), _el$4 = _el$2.firstChild, _el$5 = _el$4.firstChild, _el$6 = _el$5.nextSibling;
            ...
            _el$5.$$click = onClickLogout;
            insert(_el$5, svgLogout);
            _el$6.$$click = onClickChangePassword;
            insert(_el$6, svgChangePassword);
            return _el$2;
          }
        });
      }
...
var _tmpl$$1l = /* @__PURE__ */ template(`<div id=verdiv class="text-xs absolute left-4 bottom-2 text-gray-400"><span class=text-xs>OakVar </span><span class="curverspan text-xs">`);
const {
...
function VersionSlot() {
  ...
  return createComponent(Show, {
    ...
    get children() {
      var _el$ = _tmpl$$1l(), _el$2 = _el$.firstChild; _el$2.firstChild;
      ...
      for (const mn in rms) {
        ...
        if (m.groups.length > 0) {
          for (const g of m.groups) {
            if (rms[g].groupModuleNames == void 0) {
              rms[g].groupModuleNames = [];
            }
            rms[g].groupModuleNames.push(mn);
          }
        }
...
function createGlobalStates$7() {
  ...
  function resolveModuleOptions(rms) {
    for (const [_, m] of Object.entries(rms)) {
      var module_options = m.conf.module_options;
      if (module_options == void 0) {
        continue;
      }
      for (const [moduleOptionMn, moduleOption] of Object.entries(module_options)) {
        if (rms[moduleOptionMn] == void 0) {
          continue;
        }
        if (rms[moduleOptionMn].moduleOptions == void 0) {
          rms[moduleOptionMn].module_options = moduleOption;
        } else {
          rms[moduleOptionMn].module_options = {
            ...rms[moduleOptionMn].module_options,
            ...moduleOption
          };
        }
  ...
  function loadAllLocalModules(refresh) {
    ...
    axios.get(serverUrl + "/store/local?refresh=" + refresh).then(function(res) {
      var rms = res.data;
      for (var [mn, m] of Object.entries(rms)) {
        if (m.type == "group") {
          m.expandGroup = false;
          m.selected = false;
        }
        if (m.groups.length > 0) {
          for (const g of m.groups) {
            if (rms[g] == void 0) {
              console.log("Group " + g + " not found for module " + mn);
              continue;
            }
            if (rms[g].groupModuleNames == void 0) {
              rms[g].groupModuleNames = [];
      ...
      resolveModuleOptions(rms);
      setLocalModules(reconcile(rms));
    }).catch(function(err) {
      handleError(err);
    });
  }
  ...
  function setModuleOption(moduleName, name, option, value) {
    ...
    setLocalModules(moduleName, "module_options", name, vd);
  }
  ...
  function getFilteredLocalModules(searchText, selectedTypes, selectedTag, sort) {
    var text = searchText;
    if (text != null) {
      text = text.toLowerCase();
    }
    let moduleNames = [];
    for (const [moduleName, module] of Object.entries(localModules)) {
      let add = true;
      if (selectedTag != null) {
      ...
      if (module.groups.length > 0) {
        ...
        if (module.type == "group") {
          var hasMember = false;
          for (const [_, module2] of Object.entries(localModules)) {
            if (module2.groups.indexOf(moduleName) >= 0) {
              if (selectedTypes.length == 0 || selectedTypes.indexOf(module2.type) >= 0) {
                hasMember = true;
                break;
              }
            }
          ...
          continue;
        } else if (selectedTypes.length > 0 && selectedTypes.indexOf(module.type) == -1) {
          add = false;
        }
      }
      if (add) {
    ...
    if (sort == void 0 || sort == "Name") {
      ...
      moduleNames.sort((a, b) => localModules[b].size - localModules[a].size);
    } else if (sort == "Date") {
      moduleNames.sort((a, b) => localModules[b].publish_time > localModules[a].publish_time);
    }
    return moduleNames;
  }
  return {
...
function SideBar() {
  ...
  return (() => {
    var _el$ = _tmpl$$1k(), _el$2 = _el$.firstChild, _el$3 = _el$2.firstChild, _el$4 = _el$3.firstChild, _el$5 = _el$4.firstChild, _el$6 = _el$4.nextSibling;
    ...
    insert(_el$6, createComponent(TabHeadLogging, {}), null);
...
var _tmpl$$1h = /* @__PURE__ */ template(`<a href=# class="text-gray-600 block px-4 py-2 text-sm text-right hover:bg-gray-100 hover:text-gray-900"role=menuitem tabindex=-1 value="">`);
...
function AssemblySelectPanel(props) {
  ...
  return (() => {
    var _el$ = _tmpl$$1f(), _el$2 = _el$.firstChild, _el$3 = _el$2.firstChild; _el$3.firstChild;
...
var _tmpl$$1e = /* @__PURE__ */ template(`<a href=# class="text-gray-600 block px-4 py-2 text-sm text-right hover:bg-gray-100 hover:text-gray-900"role=menuitem tabindex=-1 value="">`);
...
function InputFormatSelectPanelSelect(props) {
  return (() => {
    var _el$ = _tmpl$$1d(), _el$2 = _el$.firstChild;
...
function InputFormatSelectPanel(props) {
  ...
  return (() => {
    var _el$ = _tmpl$$1c(), _el$2 = _el$.firstChild, _el$3 = _el$2.firstChild; _el$3.firstChild;
...
function InputDropArea(props) {
  ...
  return (() => {
    var _el$ = _tmpl$2$g(), _el$6 = _el$.firstChild, _el$7 = _el$6.firstChild, _el$8 = _el$7.firstChild, _el$9 = _el$8.nextSibling, _el$10 = _el$7.nextSibling;
    insert(_el$, createComponent(Show, {
      get when() {
        return props.inputDataDrop.length > 0;
      },
      get children() {
        var _el$2 = _tmpl$$1b(), _el$3 = _el$2.firstChild, _el$4 = _el$3.nextSibling, _el$5 = _el$4.firstChild;
...
function InputPasteArea(props) {
  ...
  return (() => {
    var _el$ = _tmpl$$1a(), _el$2 = _el$.firstChild, _el$3 = _el$2.nextSibling, _el$4 = _el$3.nextSibling, _el$5 = _el$4.firstChild;
    _el$2.$$keyup = onKeyup;
...
var _tmpl$$19 = /* @__PURE__ */ template(`<div id=job-name-div class="mt-4 w-full"><textarea id=job-name class="font-mono text-sm border-0 bg-gray-100 text-gray-600 p-4 resize-none rounded-md w-full "placeholder="(Optional) job name">`);
...
var _tmpl$$18 = /* @__PURE__ */ template(`<div id=submit-note-div class="mt-4 w-full"><textarea id=submit-note class="font-mono text-sm border-0 bg-gray-100 text-gray-600 p-4 resize-none rounded-md w-full"placeholder="(Optional) note for this job">`);
...
function InputPanel(props) {
  ...
  return (() => {
    ...
    insert(_el$2, createComponent(Show, {
      ...
      get children() {
        var _el$3 = _tmpl$$16(), _el$4 = _el$3.firstChild;
...
function getFilteredModules(modules, searchText, selectedTypes, selectedTag, sort, excludeTypes) {
  var text = searchText;
  if (text != null) {
    text = text.toLowerCase();
  }
  ...
  for (const [moduleName, module] of Object.entries(modules)) {
    ...
    if (excludeTypes.indexOf(module.type) >= 0) {
      add = false;
    ...
    if (module.groups.length > 0) {
      ...
      if (module.type == "group") {
        var hasMember = false;
        for (const [_, module2] of Object.entries(modules)) {
          if (module2.groups.indexOf(moduleName) >= 0) {
            if (selectedTypes.length == 0 || selectedTypes == "all" || selectedTypes.indexOf(module2.type) >= 0) {
              hasMember = true;
              break;
            }
          }
        ...
        continue;
      } else if (selectedTypes.length > 0 && selectedTypes != "all" && selectedTypes.indexOf(module.type) == -1) {
        add = false;
      }
    }
    if (add) {
  ...
  if (sort == void 0 || sort == "Name") {
    moduleNames.sort((a, b) => modules[a].title.localeCompare(modules[b].title));
  } else if (sort == "Size") {
    moduleNames.sort((a, b) => modules[b].size - modules[a].size);
  } else if (sort == "Date") {
    moduleNames.sort((a, b) => modules[b].publish_time > modules[a].publish_time);
  }
  return moduleNames;
}
...
function createGlobalStates$3() {
  ...
  function getInstalledModules(searchText, selectedTyes, selectedTag, updateAvailableOnly, sort) {
    ...
    for (const moduleName of getFilteredModules(remoteModules, searchText, selectedTyes, selectedTag, sort, [])) {
  ...
  function getNotInstalledModules(searchText, selectedTypes, selectedTag, sort, expandGroups) {
    const l = [];
    if (moduleInstallStates == null || Object.keys(remoteModules).length == 0) {
      return l;
    }
    for (const moduleName of getFilteredModules(remoteModules, searchText, selectedTypes, selectedTag, sort, expandGroups)) {
      const m = moduleInstallStates[moduleName];
      if (m.installed != true) {
        l.push(moduleName);
      }
...
const gvModuleInstallStates = createRoot(createGlobalStates$3);
...
const gvDetailCardState = createRoot(createGlobalStates$2);

var _tmpl$$15 = /* @__PURE__ */ template(`<a>`);
...
const gvSubmitModules = createRoot(createGlobalStates$1);
...
function deleteModule(mn) {
  ...
  if (ty == "annotator") {
    ...
    setLocalModules(mn, "selected", false);
...
function findModulesRequiredByParam(mn, l, missingList) {
  var mI = localModules$1[mn];
  if (mI == void 0) {
    mI = localModules$1[mn + "reporter"];
    if (mI == void 0) {
...
function addModuleDownNewList(mn) {
  ...
  for (var addMn of l) {
    var mI = localModules$1[addMn];
    if (mI == void 0) {
      addMn = addMn + "reporter";
      mI = localModules$1[addMn];
    }
    const ty = mI.type;
    if (ty == "annotator") {
      setAnnotators$1(addMn, mI);
      setLocalModules(addMn, "selected", true);
    } else if (ty == "postaggregator") {
...
function ModuleOption(props) {
  ...
  createEffect(function() {
    const prevModuleOption = getModuleOption(props.moduleName, props.name);
  ...
  return (() => {
    ...
    insert(_el$, createComponent(Switch, {
      ...
      get children() {
        return [createComponent(Match, {
          get when() {
            return props.values.method == "file";
          },
          get children() {
            var _el$3 = _tmpl$$14();
          ...
          get when() {
            return props.values.method == "select";
          },
          get children() {
            var _el$4 = _tmpl$2$e();
            ...
            createRenderEffect(() => setAttribute(_el$4, "title", props.values.help));
    ...
    createRenderEffect(() => setAttribute(_el$2, "title", props.values.help));
    return _el$;
  })();
}
...
function ModuleCard(props) {
  ...
  function onClickLogo(_) {
    if (props.kind == "remote") {
      if (props.moduleInfo.type == "group") {
        setRemoteModules(props.moduleName, "expandGroup", !props.remoteModuleInfo.expandGroup);
      } else {
        setDetailModuleName(props.moduleName);
        setShowDetailCard(true);
      }
    } else if (props.kind == "local") {
      if (props.localModuleInfo.type == "group") {
        setLocalModules(props.moduleName, "expandGroup", !props.localModuleInfo.expandGroup);
      } else {
        setDetailModuleName(props.moduleName);
        setShowDetailCard(true);
      }
  ...
  function expandGroup(_) {
    if (props.kind == "remote") {
      setRemoteModules(props.moduleName, "expandGroup", true);
    } else {
      setLocalModules(props.moduleName, "expandGroup", true);
    }
  }
  function collapseGroup(_) {
    if (props.kind == "remote") {
      setRemoteModules(props.moduleName, "expandGroup", false);
    } else {
      setLocalModules(props.moduleName, "expandGroup", false);
    }
  }
  function onMouseEnter(_) {
    setShowX(true);
  }
  ...
  function setSelected(val) {
    if (props.kind == "remote") {
      setRemoteModules(props.moduleName, "selected", val);
    } else {
      setLocalModules(props.moduleName, "selected", val);
    }
  }
  ...
  function removeUpModule(_) {
    deleteModuleUp(props.moduleName);
    setSelected(false);
  }
  function removeDownModule(_) {
    deleteModuleUp(props.moduleName);
  ...
  return (() => {
    ...
    insert(_el$2, createComponent(Switch, {
      get children() {
        return [createComponent(Match, {
          get when() {
            return props.moduleInfo.type == "group" && props.moduleInfo.expandGroup == false;
          },
          get children() {
            var _el$3 = _tmpl$$13();
            _el$3.$$click = expandGroup;
          ...
          get when() {
            return props.moduleInfo.type == "group" && props.moduleInfo.expandGroup == true;
          },
          get children() {
            var _el$4 = _tmpl$$13();
            _el$4.$$click = collapseGroup;
          ...
          get when() {
            return props.moduleInfo.type != "group" && !props.moduleInfo.selected;
          },
          get children() {
            var _el$5 = _tmpl$$13();
            _el$5.$$click = addModule;
          ...
          get children() {
            return [(() => {
              var _el$6 = _tmpl$2$d();
              _el$6.$$click = removeUpModule;
              insert(_el$6, createComponent(Button, {
                "class": "details-button w-full text-sm h-8 cursor-pointer",
                bgColor: "bg-white",
                bgHoverColor: "hover:bg-gray-100",
                onClick: removeUpModule,
                children: "RemoveUp"
              }));
              return _el$6;
            })(), (() => {
    ...
    _el$9.$$click = onClickLogo;
    insert(_el$9, createComponent(Switch, {
      get children() {
        return [createComponent(Match, {
          get when() {
            return props.moduleInfo.has_logo;
          },
          get children() {
            return createComponent(Switch, {
              get children() {
                return [createComponent(Match, {
                  get when() {
                    return props.kind == "remote";
                  },
                  get children() {
                    var _el$10 = _tmpl$4$6();
                    createRenderEffect(() => setAttribute(_el$10, "src", `${serverUrl}/store/remotelogo?module=${props.moduleName}&store=${props.remoteModuleInfo.store}`));
                    return _el$10;
                  }
                }), createComponent(Match, {
                  get when() {
                    return props.kind == "local";
                  },
                  get children() {
                    var _el$11 = _tmpl$4$6();
                    createRenderEffect(() => setAttribute(_el$11, "src", `${serverUrl}/store/locallogo?module=${props.moduleName}`));
                    return _el$11;
                  }
                })];
              }
          ...
          get children() {
            ...
            insert(_el$12, () => props.moduleInfo.title);
            return _el$12;
          }
        })];
      }
    }));
    insert(_el$15, () => props.moduleInfo.title);
    insert(_el$16, createComponent(Switch, {
      get children() {
        return [createComponent(Match, {
          ...
          get children() {
            return props.remoteModuleInfo.latest_version;
          }
        }), createComponent(Match, {
          get when() {
            return props.kind == "local";
          ...
          get children() {
            return props.localModuleInfo.code_version;
          }
        })];
      }
    }));
    insert(_el$14, createComponent(Show, {
      get when() {
        return props.moduleInfo.conf.data_version != void 0;
      },
      get children() {
        var _el$17 = _tmpl$6$2();
        insert(_el$17, () => props.moduleInfo.conf.data_version);
        return _el$17;
      }
    }), null);
    insert(_el$18, createComponent(Switch, {
      get children() {
        return [createComponent(Match, {
          ...
          get children() {
            return props.moduleInfo.conf.description;
          }
        }), createComponent(Match, {
          get when() {
            return props.kind == "local";
          ...
          get children() {
            return props.localModuleInfo.conf.description;
          }
        })];
      }
    }));
    insert(_el$19, createComponent(Show, {
      get when() {
        return props.moduleInfo.size != void 0;
      },
      get children() {
        var _el$20 = _tmpl$7();
        insert(_el$20, () => getSizeString(props.moduleInfo.size));
        return _el$20;
      }
    }), _el$21);
    ...
    insert(_el$, createComponent(Show, {
      get when() {
        return props.moduleInfo.selected == true && props.selectedCard == true && props.moduleInfo.module_options != void 0;
      },
      get children() {
        return createComponent(For, {
          get each() {
            return Object.keys(props.moduleInfo.module_options);
          },
          children: (optionKey) => createComponent(ModuleOption, {
            get moduleName() {
              return props.moduleName;
            },
            name: optionKey,
            get values() {
              return props.moduleInfo.module_options[optionKey];
            }
          })
        });
      }
    ...
    createRenderEffect((_p$) => {
      var _v$ = !!(props.moduleInfo.groups.length && !props.doNotIndent), _v$2 = !!props.moduleInfo.selected, _v$3 = !props.moduleInfo.selected, _v$4 = props.moduleInfo.name, _v$5 = props.moduleInfo.kind, _v$6 = !!(!showX() || props.kind == "remote"), _v$7 = !!(props.moduleInfo.type != "group"), _v$8 = !!(props.moduleInfo.type == "group"), _v$9 = props.moduleInfo.type == "group" ? "Click to expand group" : "Click for details", _v$10 = !!(props.moduleInfo.size != void 0);
      _v$ !== _p$.e && _el$.classList.toggle("ml-16", _p$.e = _v$);
      _v$2 !== _p$.t && _el$.classList.toggle("bg-gray-200", _p$.t = _v$2);
      _v$3 !== _p$.a && _el$.classList.toggle("bg-white", _p$.a = _v$3);
      _v$4 !== _p$.o && setAttribute(_el$, "name", _p$.o = _v$4);
      _v$5 !== _p$.i && setAttribute(_el$, "kind", _p$.i = _v$5);
      _v$6 !== _p$.n && _el$2.classList.toggle("hidden", _p$.n = _v$6);
      _v$7 !== _p$.s && _el$9.classList.toggle("cursor-help", _p$.s = _v$7);
      _v$8 !== _p$.h && _el$9.classList.toggle("cursor-pointer", _p$.h = _v$8);
      _v$9 !== _p$.r && setAttribute(_el$9, "title", _p$.r = _v$9);
      _v$10 !== _p$.d && _el$21.classList.toggle("ml-2", _p$.d = _v$10);
      return _p$;
    }, {
      e: void 0,
      t: void 0,
...
function ReportChoicePanel() {
  ...
  return (() => {
    ...
    insert(_el$3, createComponent(For, {
      ...
      children: (reportType) => createComponent(ModuleCard, {
        kind: "local",
        moduleName: reportType + "reporter",
        doNotIndent: true,
        get remoteModuleInfo() {
          return remoteModules[reportType + "reporter"];
        },
        get localModuleInfo() {
          return localModules[reportType + "reporter"];
        },
        get moduleInfo() {
          return localModules[reportType + "reporter"];
        }
...
function CtaScrollDownToAnalysisModule(props) {
  ...
  return (() => {
    var _el$ = _tmpl$$11(), _el$2 = _el$.firstChild, _el$3 = _el$2.firstChild, _el$4 = _el$3.firstChild, _el$5 = _el$4.firstChild, _el$6 = _el$5.firstChild;
...
var _tmpl$$10 = /* @__PURE__ */ template(`<button type=button class=filter-category>`);
...
var _tmpl$$$ = /* @__PURE__ */ template(`<a href=# class="text-gray-600 block px-4 py-2 text-sm text-right hover:bg-gray-100 hover:text-gray-900"role=menuitem tabindex=-1 value="">`);
...
var _tmpl$$_ = /* @__PURE__ */ template(`<div class="option-list ease-in absolute right-0 z-10 mt-2 w-24 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"role=menu aria-orientation=vertical aria-labelledby=menu-button tabindex=-1><div class=py-1 role=none>`);
...
function SortPanel(props) {
  ...
  return (() => {
    var _el$ = _tmpl$$Z(), _el$2 = _el$.firstChild, _el$3 = _el$2.firstChild, _el$4 = _el$3.firstChild; _el$4.firstChild;
    _el$3.$$click = toggleShowSelect;
...
var _tmpl$$Y = /* @__PURE__ */ template(`<a href=# class="text-gray-600 block px-4 py-2 text-sm text-right bg-gray-200 hover:bg-gray-100 hover:text-gray-900"role=menuitem tabindex=-1 value="">`), _tmpl$2$c = /* @__PURE__ */ template(`<a href=# class="text-gray-600 block px-4 py-2 text-sm text-right hover:bg-gray-100 hover:text-gray-900"role=menuitem tabindex=-1 value="">`);
...
var _tmpl$$X = /* @__PURE__ */ template(`<div class="option-list ease-in absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"role=menu aria-orientation=vertical aria-labelledby=menu-button tabindex=-1><div class=py-1 role=none>`);
function TypeSelect(props) {
  return (() => {
    var _el$ = _tmpl$$X(), _el$2 = _el$.firstChild;
    insert(_el$2, createComponent(TypeOption, {
      value: "all",
      title: "All",
      get type() {
        return props.type;
    ...
    insert(_el$2, createComponent(Show, {
      ...
      get children() {
        return [createComponent(TypeOption, {
          value: "converter",
          title: "Converter",
          get type() {
            return props.type;
    ...
    insert(_el$2, createComponent(TypeOption, {
      value: "postaggregator",
      title: "Postaggregator",
      get type() {
        return props.type;
      },
      get setType() {
    ...
    insert(_el$2, createComponent(Show, {
      ...
      get children() {
        return [createComponent(TypeOption, {
          ...
          value: "webviewerwidget",
          title: "Webviewer Widget",
          get type() {
            return props.type;
          },
          get setType() {
...
function TypePanel(props) {
  ...
  function getTypeTitle() {
    if (props.type == "all") {
      return "All";
    } else if (props.type == "converter") {
      return "Converter";
    } else if (props.type == "mapper") {
      return "Mapper";
    } else if (props.type == "annotator") {
      return "Annotator";
    } else if (props.type == "postaggregator") {
      return "Postaggregator";
    } else if (props.type == "reporter") {
      return "Reporter";
    } else if (props.type == "webviewerwidget") {
      return "Webviewer Widget";
    } else {
      return "NA";
    }
  }
  return (() => {
    var _el$ = _tmpl$$W(), _el$2 = _el$.firstChild, _el$3 = _el$2.firstChild, _el$4 = _el$3.firstChild;
    _el$3.$$click = toggleShowSelect;
    insert(_el$4, getTypeTitle);
    insert(_el$3, createComponent(HiOutlineChevronDown, {
      "class": "ml-2 h-5 w-5"
    }), null);
    insert(_el$, createComponent(TypeSelect, {
      get kind() {
        return props.kind;
      },
      get type() {
...
function ModuleSearchPanel(props) {
  ...
  function onChangeExpandGroups(_) {
    props.setExpandGroups(!props.expandGroups);
  }
  function getTitle() {
  ...
  function getExpandGroupsTitle() {
    if (props.expandGroups) {
      return "Click to collapse groups";
    } else {
      return "Click to expand groups";
    }
  }
  return (() => {
    ...
    insert(_el$4, createComponent(Show, {
      get when() {
        return props.showInstalledOnlyButton;
      },
      get children() {
        var _el$5 = _tmpl$2$b();
        insert(_el$5, createComponent(Show, {
          ...
          get children() {
            ...
            insert(_el$6, createComponent(Show, {
              ...
              get fallback() {
                return createComponent(BsCloudCheck, {
                  size: 22
                });
              },
              get children() {
                return createComponent(BsCloudCheckFill, {
                  size: 22
                });
              }
            }));
    ...
    insert(_el$4, createComponent(TypePanel, {
      get kind() {
        return props.kind;
      },
      get type() {
    ...
    _el$7.$$click = onChangeExpandGroups;
    insert(_el$7, createComponent(Show, {
      get when() {
        return props.expandGroups;
      },
      get fallback() {
    ...
    createRenderEffect((_p$) => {
      var _v$3 = getExpandGroupsTitle(), _v$4 = !!props.expandGroups;
      _v$3 !== _p$.e && setAttribute(_el$7, "title", _p$.e = _v$3);
      _v$4 !== _p$.t && _el$7.classList.toggle("checked", _p$.t = _v$4);
      return _p$;
    }, {
      e: void 0,
      t: void 0
...
var _tmpl$$U = /* @__PURE__ */ template(`<div class="flex items-center justify-center"><p class="text-lg text-gray-700">No module met the criteria.`), _tmpl$2$a = /* @__PURE__ */ template(`<div>`);
function ModuleDisplayPanel(props) {
  ...
  return (() => {
    ...
    insert(_el$2, createComponent(Show, {
      get when() {
        return props.moduleNames != void 0 && props.moduleNames.length > 0;
      },
      get fallback() {
      ...
      get children() {
        return createComponent(For, {
          ...
          children: (moduleName) => (() => {
            var _el$3 = _tmpl$2$a();
            insert(_el$3, createComponent(ModuleCard, {
              moduleName,
              get kind() {
                return props.kind;
              },
              ...
              get moduleInfo() {
                return props.kind == "remote" ? remoteModules[moduleName] : localModules[moduleName];
              }
            }), null);
            insert(_el$3, createComponent(Switch, {
              get children() {
                return [createComponent(Match, {
                  get when() {
                    return props.kind == "remote" && (props.expandGroups || remoteModules[moduleName].expandGroup);
                  },
                  get children() {
                    return createComponent(For, {
                      get each() {
                        return remoteModules[moduleName].groupModuleNames;
                      },
                      children: (groupModuleName) => createComponent(ModuleCard, {
                        moduleName: groupModuleName,
                        get kind() {
                          return props.kind;
                        },
                        get remoteModuleInfo() {
                          return remoteModules[groupModuleName];
                        },
                        get localModuleInfo() {
                          return localModules[groupModuleName];
                        },
                        get moduleInfo() {
                          return remoteModules[groupModuleName];
                        }
                  ...
                  get when() {
                    return props.kind == "local" && (props.expandGroup || localModules[moduleName].expandGroup);
                  },
                  get children() {
                    return createComponent(For, {
                      get each() {
                        return localModules[moduleName].groupModuleNames;
                      },
                      children: (groupModuleName) => createComponent(ModuleCard, {
                        moduleName: groupModuleName,
                        get kind() {
...
var _tmpl$$T = /* @__PURE__ */ template(`<div id=analysis-module-filter-panel-all class="analysis-module-filter-panel w-full mt-4 overflow-auto">`);
function AnalysisModuleFilterPanelAll(props) {
  ...
  const [type, setType] = createSignal("annotator");
  const [expandGroups, setExpandGroups] = createSignal(false);
  const [moduleNames, setModuleNames] = createSignal([]);
  const {
    localModules
  } = gvLocalModules;
  createEffect(function() {
    setModuleNames(getFilteredModules(localModules, searchText(), type(), null, sort(), ["converter", "mapper", "webviewerwidget", "webapp"]));
  });
  return (() => {
    var _el$ = _tmpl$$T();
...
var _tmpl$$S = /* @__PURE__ */ template(`<div class="relative flex items-start mb-2"><div class="flex items-center"><input type=radio name=module-tag class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-500"><label class="ml-3 block text-sm font-medium text-gray-600">`);
...
function AnalysisModuleFilterPanelTagItem(props) {
  ...
  function isSelected() {
    return props.selectedTag == props.value;
  }
  return (() => {
    var _el$ = _tmpl$$S(), _el$2 = _el$.firstChild, _el$3 = _el$2.firstChild, _el$4 = _el$3.nextSibling;
    ...
    createRenderEffect(() => _el$3.checked = isSelected());
    return _el$;
  })();
}
delegateEvents(["click"]);
...
function AnalysisModuleFilterPanelTags(props) {
  ...
  const [searchText, setSearchText] = createSignal(null);
  const [selectedTag, setSelectedTag] = createSignal("allele frequency");
  const [sort, setSort] = createSignal("Name");
  ...
  createEffect(function() {
    setModuleNames(getFilteredModules(localModules, searchText(), type(), selectedTag(), sort(), ["converter", "mapper", "webviewerwidget", "webapp"]));
  });
  return (() => {
...
var _tmpl$$Q = /* @__PURE__ */ template(`<div class="analysis-module-filter-wrapper col-span-7"><div id=analysis-module-filter-kinds class=w-full><div class="inline-flex rounded-md shadow-sm"role=group>`);
...
function SelectedAnalysisModules() {
  ...
  return (() => {
    var _el$ = _tmpl$$P(), _el$2 = _el$.firstChild, _el$3 = _el$2.nextSibling, _el$4 = _el$3.firstChild, _el$5 = _el$3.nextSibling;
...
function CtaScrollUpToInput(props) {
  ...
  return (() => {
    var _el$ = _tmpl$$O(), _el$2 = _el$.firstChild, _el$3 = _el$2.firstChild, _el$4 = _el$3.firstChild, _el$5 = _el$4.firstChild, _el$6 = _el$5.firstChild;
...
var _tmpl$$M = /* @__PURE__ */ template(`<li><a href=# class="block hover:bg-gray-50"><div class=py-4><div class="flex items-center justify-between"><p class="truncate text-sm font-medium text-indigo-600"></p></div><div class="mt-2 sm:flex sm:justify-between"><div class="mt-2 w-full flex items-center text-sm text-gray-500 sm:mt-0"><div class="w-full bg-gray-200 rounded-full dark:bg-gray-700"><div class="bg-blue-600 text-xs font-medium text-blue-100 text-center p-0.5 leading-none rounded-full">%`);
function UploadProgressFile(props) {
  return (() => {
    var _el$ = _tmpl$$M(), _el$2 = _el$.firstChild, _el$3 = _el$2.firstChild, _el$4 = _el$3.firstChild, _el$5 = _el$4.firstChild, _el$6 = _el$4.nextSibling, _el$7 = _el$6.firstChild, _el$8 = _el$7.firstChild, _el$9 = _el$8.firstChild, _el$10 = _el$9.firstChild;
...
function UploadProgressDialog(props) {
  ...
  return (() => {
    var _el$ = _tmpl$$L(), _el$2 = _el$.firstChild, _el$3 = _el$2.nextSibling, _el$4 = _el$3.firstChild, _el$5 = _el$4.firstChild, _el$6 = _el$5.firstChild, _el$7 = _el$6.firstChild, _el$8 = _el$7.firstChild, _el$9 = _el$6.nextSibling, _el$10 = _el$9.firstChild;
...
function TabSubmit(props) {
  ...
  const [showWarnDialog, setShowWarnDialog] = createSignal(false);
  let inputFiles = [];
  let formData = null;
  let submitOption = {};
  let controller;
  ...
  function makeFormData(inputNo) {
    ...
    return addSubmitOptionsToFormData();
  }
  function submitFn() {
    var c = 0;
    for (const _ in annotators) {
      c += 1;
    }
    for (const _ in postaggregators) {
      c += 1;
    }
    if (c == 0) {
  ...
  function doSubmit() {
    if (separateJobPerFile() == true) {
      return processSeparateInputSubmit();
    } else {
      return processCombineInputSubmit();
    }
  }
  return (() => {
    ...
    insert(_el$, createComponent(Show, {
      ...
      get children() {
        return createComponent(SubmitWarnDialog, {
          title: "Warning",
          get text() {
            return _tmpl$4$5();
          },
...
var _tmpl$$I = /* @__PURE__ */ template(`<a href=# class="text-gray-600 block px-4 py-2 text-sm text-right hover:bg-gray-100 hover:text-gray-900"role=menuitem tabindex=-1 value="">`);
...
var _tmpl$$H = /* @__PURE__ */ template(`<div class="option-list ease-in absolute right-0 z-10 mt-12 w-24 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"role=menu><div class=py-1 role=none>`);
...
function ActionPanel(props) {
  ...
  return (() => {
    var _el$ = _tmpl$$G(), _el$2 = _el$.firstChild, _el$3 = _el$2.firstChild; _el$3.firstChild;
    _el$3.$$click = toggleShowSelect;
    insert(_el$3, createComponent(HiOutlineChevronDown, {
      "class": "-mr-1 ml-2 h-5 w-5"
    }), null);
...
function JobRow(props) {
  ...
  return (() => {
    var _el$7 = _tmpl$6$1(), _el$8 = _el$7.firstChild, _el$9 = _el$8.firstChild, _el$10 = _el$8.nextSibling, _el$11 = _el$10.nextSibling, _el$12 = _el$11.nextSibling, _el$13 = _el$12.nextSibling, _el$14 = _el$13.nextSibling, _el$15 = _el$14.nextSibling, _el$16 = _el$15.nextSibling, _el$17 = _el$16.nextSibling, _el$18 = _el$17.nextSibling;
...
function JobTable(props) {
  ...
  return (() => {
    var _el$ = _tmpl$$D(), _el$2 = _el$.firstChild, _el$3 = _el$2.firstChild, _el$4 = _el$3.firstChild, _el$5 = _el$4.firstChild, _el$6 = _el$5.firstChild, _el$7 = _el$6.firstChild, _el$8 = _el$4.nextSibling;
...
function MsgDialog(props) {
  return (() => {
    var _el$ = _tmpl$$C(), _el$2 = _el$.firstChild, _el$3 = _el$2.nextSibling, _el$4 = _el$3.firstChild, _el$5 = _el$4.firstChild, _el$6 = _el$5.firstChild, _el$7 = _el$6.firstChild, _el$8 = _el$7.firstChild;
...
var _tmpl$$B = /* @__PURE__ */ template(`<div id=tab_jobs class="tabcontent px-6 mb-4"><div>`);
const {
...
function ModuleFilterPanelHome(props) {
  ...
  return (() => {
    ...
    insert(_el$5, createComponent(ModuleCard, {
      ...
      kind: "remote",
      get remoteModuleInfo() {
        return remoteModules["civic"];
      },
      get localModuleInfo() {
        return localModules["civic"];
      },
      get moduleInfo() {
        return remoteModules["civic"];
      }
    ...
    insert(_el$5, createComponent(ModuleCard, {
      ...
      kind: "remote",
      get remoteModuleInfo() {
        return remoteModules["clinvar"];
      },
      get localModuleInfo() {
        return localModules["clinvar"];
      },
      get moduleInfo() {
        return remoteModules["clinvar"];
      }
    ...
    insert(_el$5, createComponent(ModuleCard, {
      ...
      get localModuleInfo() {
        return localModules["gwas_catalog"];
      },
      get moduleInfo() {
        return remoteModules["gwas_catalog"];
      }
    ...
    insert(_el$5, createComponent(ModuleCard, {
      ...
      kind: "remote",
      get remoteModuleInfo() {
        return remoteModules["thousandgenomes"];
      },
      get localModuleInfo() {
        return localModules[moduleName];
      },
    ...
    insert(_el$5, createComponent(ModuleCard, {
      ...
      kind: "remote",
      get remoteModuleInfo() {
        return remoteModules["gnomad3"];
      },
      get localModuleInfo() {
        return localModules["gnomad3"];
      },
      get moduleInfo() {
        return remoteModules["gnomad3"];
      }
    ...
    insert(_el$5, createComponent(ModuleCard, {
      ...
      kind: "remote",
      get remoteModuleInfo() {
        return remoteModules["pharmgkb"];
      },
      get localModuleInfo() {
        return localModules["pharmgkb"];
      },
      get moduleInfo() {
        return remoteModules["pharmgkb"];
      }
...
var _tmpl$$z = /* @__PURE__ */ template(`<div class="remote-module-filter-panel w-full mt-4 overflow-auto">`);
const {
...
function ModuleFilterPanelAll(props) {
  ...
  createEffect(function() {
    if (notInstalledOnly() == true) {
      setModuleNames(getNotInstalledModules$1(searchText(), [type()], null, sort()));
    } else {
      setModuleNames(getFilteredModules(remoteModules, searchText(), [type()], null, sort(), []));
    }
  });
  return (() => {
    var _el$ = _tmpl$$z();
...
var _tmpl$$y = /* @__PURE__ */ template(`<div class="remote-module-filter-panel w-full mt-4 overflow-auto flex"><div class="store-filtered-modules col-span-1 flex flex-col justify-leading pl-1 overflow-y-auto w-[20rem]"></div><div class="ml-8 w-full">`);
const {
...
function ModuleFilterPanelTags(props) {
  ...
  createEffect(function() {
    if (notInstalledOnly() == true) {
      setModuleNames(getNotInstalledModules(searchText(), [type()], selectedTag(), sort()));
    } else {
      setModuleNames(getFilteredModules(remoteModules$1, searchText(), [type()], selectedTag(), sort(), []));
    }
  });
  return (() => {
...
function ModuleFilterPanelInstalled(props) {
  ...
  const [moduleNames, setModuleNames] = createSignal([]);
  createEffect(function() {
    setModuleNames(getInstalledModules$1(searchText(), [type()], null, null, sort()));
  });
  return (() => {
    var _el$ = _tmpl$$x();
    insert(_el$, createComponent(ModuleSearchPanel, {
...
var _tmpl$$w = /* @__PURE__ */ template(`<div class="remote-module-filter-panel w-full mt-4 overflow-auto">`);
const {
  getInstalledModules
} = gvModuleInstallStates;
...
function RemoteModuleFilterWrapper(props) {
  ...
  return (() => {
    var _el$ = _tmpl$2$7(), _el$2 = _el$.firstChild, _el$3 = _el$2.firstChild, _el$4 = _el$3.firstChild;
    insert(_el$3, createComponent(ModuleFilterCategoryButton, {
      value: "home",
      title: "Home",
      pos: "left",
...
var _tmpl$$s = /* @__PURE__ */ template(`<div class="h-[8rem] px-2 flex items-center rounded-lg border border-gray-300 bg-white shadow-sm"><div class="flex overflow-auto w-full">`);
const {
  installQueue,
  installState
} = gvInstallQueue;
function InstallQueuePanel(props) {
  return createComponent(Show, {
    ...
    get children() {
      ...
      createRenderEffect(() => _el$.classList.toggle("border-blue-500", !!(installQueue.length > 0)));
      return _el$;
    }
  });
}

var _tmpl$$r = /* @__PURE__ */ template(`<div class="h-64 w-64 m-auto flex"><div class="m-auto flex flex-col"><div class=mb-4>Loading store modules...</div><div class=m-auto>`);
function LoadingPanel() {
  return (() => {
    var _el$ = _tmpl$$r(), _el$2 = _el$.firstChild, _el$3 = _el$2.firstChild, _el$4 = _el$3.nextSibling;
...
var _tmpl$$q = /* @__PURE__ */ template(`<div role=tooltip class="absolute top-0 right-0 inline-block z-10 p-4 text-sm font-medium text-gray-700 bg-gray-200 border border-gray-200 rounded-lg shadow-lg transition-opacity duration-300 tooltip dark:bg-gray-700 opacity-0 w-[24rem] break-word"><div class=tooltip-arrow data-popper-arrow>`);
...
var _tmpl$$p = /* @__PURE__ */ template(`<div id=tab-store class="tabcontent p-4 snap-y snap-mandatory h-screen overflow-y-auto flex flex-col">`);
function TabStore() {
  const {
    remoteModules
  } = gvRemoteModules;
...
function InviteUserDialog(props) {
  ...
  function close() {
    ...
    props.setShowInviteDialog(false);
  }
  function invite() {
    setInviting(true);
    const site_url = window.location.origin;
    let emailsText = emailsRef.value;
    let emailsLines = emailsText.split("\n");
    let emails = [];
    for (const emailsLine of emailsLines) {
      const emailsInput = emailsLine.split(" ");
      for (const emailInput of emailsInput) {
    ...
    axios({
      method: "post",
      url: serverUrl + "/server/inviteusers",
      data,
      withCredentials
    }).then(function(res) {
      setInviting(false);
  ...
  return (() => {
    ...
    insert(_el$2, createComponent(Show, {
      ...
      get children() {
        var _el$4 = _tmpl$$o(), _el$5 = _el$4.firstChild, _el$6 = _el$5.firstChild, _el$7 = _el$6.nextSibling;
        var _ref$ = emailsRef;
        typeof _ref$ === "function" ? use(_ref$, _el$7) : emailsRef = _el$7;
        return _el$4;
      }
    }), _el$8);
    insert(_el$8, createComponent(Show, {
      get when() {
        return inviteSuccess() == false;
      },
      get fallback() {
        return (() => {
      ...
      get children() {
        var _el$9 = _tmpl$2$5(), _el$10 = _el$9.firstChild, _el$11 = _el$10.firstChild;
        _el$9.$$click = invite;
    ...
    _el$12.$$click = props.setShowInviteDialog;
    _el$12.$$clickData = false;
    createRenderEffect(() => _el$.classList.toggle("hidden", !!(props.showInviteDialog == false)));
    return _el$;
  })();
}
delegateEvents(["click"]);
...
function UserManagement() {
  ...
  return (() => {
    var _el$ = _tmpl$$n(), _el$2 = _el$.firstChild, _el$3 = _el$2.nextSibling, _el$4 = _el$3.firstChild, _el$5 = _el$4.nextSibling, _el$6 = _el$5.firstChild, _el$7 = _el$6.nextSibling;
    _el$4.$$click = setShowInviteDialog;
    _el$4.$$clickData = true;
    insert(_el$7, createComponent(For, {
      get each() {
        return users();
      },
      children: (user) => (() => {
        var _el$8 = _tmpl$5(), _el$9 = _el$8.firstChild, _el$11 = _el$9.nextSibling;
        insert(_el$9, () => user.email, null);
        ...
        insert(_el$11, createComponent(Show, {
          ...
          get fallback() {
            return (() => {
              var _el$14 = _tmpl$6();
              _el$14.$$click = makeAdmin;
              _el$14.$$clickData = user.email;
              return _el$14;
            })();
          },
          get children() {
        ...
        insert(_el$11, createComponent(Show, {
          ...
          get children() {
            var _el$13 = _tmpl$4$1();
            _el$13.$$click = removeUser;
    ...
    insert(_el$, createComponent(InviteUserDialog, {
      get showInviteDialog() {
...
function DetailCardOutputTable(props) {
  return (() => {
    ...
    insert(_el$4, createComponent(For, {
      ...
      children: (col) => (() => {
        var _el$5 = _tmpl$2$3(), _el$6 = _el$5.firstChild, _el$7 = _el$6.nextSibling, _el$8 = _el$7.nextSibling;
...
function SignUp(props) {
  ...
  const errorCodeToText = {
    ...
    "account-exists": "Account already exists.",
    "auth/too-many-requests": "Too many failed attempts. Wait for a while and try again, or use Forgot your password? link.",
    "email-not-allowed": "This email is not allowed."
  };
  const {
    serverUrl,
    withCredentials
