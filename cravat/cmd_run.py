...
parser_fn_run.add_argument("--filter", default=None, help=argparse.SUPPRESS)
...
class Cravat(object):
    ...
    def make_self_args_considering_package_conf(self, supplied_args):
        full_args = util.get_argument_parser_defaults(parser_fn_run)
        # package
